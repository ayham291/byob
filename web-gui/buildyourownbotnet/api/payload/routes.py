...
def payload_generate():
    ...
    print("Generating payload with options: encrypt={}, compress={}, freeze={}, gui=1, owner={}, ip={}, operating_system={}, architecture={}".format(encrypt, compress, freeze, current_user.username, ip, operating_system, architecture))
    options = {
        'encrypt': encrypt,
        'compress': compress, 
        'freeze': freeze, 
    ...
    try:
        ...
        payload_dao.add_user_payload(current_user.id, ip, os.path.basename(outfile), operating_system, architecture)
